...
public class MinimaxMusicGenerationService implements MusicGenerationService {
    ...
    public void init() {
        ...
        this.apiKey = providerConfigService.getByProviderCodeAndServiceType(PROVIDER_NAME, ModelTypeEnum.MusicGen.name()).getAuthorization();
        this.url = providerConfigService.getByProviderCodeAndServiceType(PROVIDER_NAME, ModelTypeEnum.MusicGen.name()).getBaseUrl();
